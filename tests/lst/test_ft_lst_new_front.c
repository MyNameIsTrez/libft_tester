...
Test(ft_lst_new_front)
{
	...
	old_lst = lst;
	m_safe_assert(void *, new_lst = ft_lst_new_front(&lst, strdup("foo")), new_lst, NULL, true);
	...
	old_lst = lst;
	m_safe_assert(void *, new_lst = ft_lst_new_front(&lst, strdup("bar")), new_lst, NULL, true);
	if (NOT was_malloc_unstable)
	{
	...
	old_lst = lst;
	m_safe_assert(void *, new_lst = ft_lst_new_front(&lst, strdup("baz")), new_lst, NULL, true);
	if (NOT was_malloc_unstable)
	{
